...
| -rf       | --region_file           | String   |           | File with chromosomal regions of interest in format (tab delimited): region contig_name (e.g. chr17:7571739-7590808 TP53)                               |
| -af       | --annotation_file       | String   |           | File with chromosomal region annotations in format (tab delimited): contig_name region (e.g. TP53 chr17:7571739-7590808 TP53 protein_coding dna_repair) |
